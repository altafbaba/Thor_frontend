...
export class MaintenanceComponent {
  ...
  search() {
    // this.rData.value.markAllAsTouched();

    if (this.rData.invalid) return;
    ...
    //   this.snackBar.open('save','close')._dismissAfter(2000)
    // }else{
    //   this.snackBar.open('error','close')._dismissAfter(2000)
    // }
  }
